...
export default function BrandHero({ brandsCount }: BrandHeroProps) {
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
          ...
          <div ref={tagRef} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, marginBottom: 20, opacity: 0 }}>
            ...
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: 10, letterSpacing: '0.22em', color: CR, textTransform: 'uppercase', fontWeight: 600 }}>Our Clients</span>
          </div>
          ...
          >
            Trusted by {brandsCount}+ leading food brands across India and 40+ countries — from retail giants to premium export labels.
          </p>

          {/* Stats strip */}
          <div ref={statsRef} style={{ display: 'flex', gap: 'clamp(24px,3vw,48px)', flexWrap: 'wrap' }}>
            {[
              { value: `${brandsCount}+`, label: 'Active Brands' },
          ...
          >
            <div ref={imgInnerRef} style={{ position: 'absolute', inset: -20 }}>
              <Image
                ...
                alt="LV Spices Products and Packaging"
                fill
                priority
