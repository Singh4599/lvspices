      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
          ...
          <div ref={tagRef} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, marginBottom: 20, opacity: 0 }}>
            ...
            <span style={{ fontFamily: 'var(--font-mono)', fontSize: 10, letterSpacing: '0.22em', color: CR, textTransform: 'uppercase', fontWeight: 600 }}>Careers</span>
          </div>
          ...
          >
            We are always looking for talented people with a passion for quality. Join 500+ professionals building the future of Indian spice exports.
          </p>
