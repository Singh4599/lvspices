...
export default function ServicesIntro() {
  ...
  const sketchUnderlineRef = useRef<SVGPathElement>(null);
  ...
  // Sketch underline animation (runs after textRef appears)
  useEffect(() => {
    if (!sketchUnderlineRef.current) return;
    const el = sketchUnderlineRef.current;
        ...
        >
          ...
          <div ref={textRef} style={{ opacity: 0 }}>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, marginBottom: 20 }}>
              ...
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: 10, letterSpacing: '0.22em', color: CR, textTransform: 'uppercase', fontWeight: 600 }}>Overview</span>
            </div>
            <div style={{ position: 'relative', display: 'inline-block', marginBottom: 20 }}>
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(28px,3.5vw,52px)', fontWeight: 800, color: '#111', lineHeight: 1.03, letterSpacing: '-0.04em', margin: 0 }}>
                End-to-End<br />Solutions
              </h2>
              {/* Ink sketch underline */}
              <svg style={{ position: 'absolute', bottom: -6, left: 0, width: '100%', height: 12, overflow: 'visible' }} fill="none">
                <path
                  ref={sketchUnderlineRef}
                  d="M2 6 Q40 2 90 6 Q140 10 180 5 Q220 2 260 6"
                  stroke="#111111"
                  strokeWidth="1.8"
                  strokeLinecap="round"
                  opacity="0.22"
            ...
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: 'clamp(13px,1.1vw,16px)', color: '#6D6962', lineHeight: 1.8, maxWidth: 260, marginBottom: 32 }}>
              We provide comprehensive spice manufacturing services including bulk supply, private labeling, OEM packaging, and custom spice blend development for global markets.
            </p>
            ...
            >
              ...
              <span style={{ fontFamily: 'var(--font-sans)', fontSize: 12, letterSpacing: '0.1em', color: CR, fontWeight: 600, textTransform: 'uppercase' }}>View Capabilities</span>
            </button>
          </div>
          ...
          >
            ...
            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '32px 24px 20px', background: 'linear-gradient(to top, rgba(17,17,17,0.65) 0%, transparent 100%)' }}>
              <span style={{ fontFamily: 'var(--font-sans)', fontSize: 12, letterSpacing: '0.1em', color: 'rgba(255,255,255,0.8)', textTransform: 'uppercase' }}>
                Custom blending and packaging tailored to your brand.
              </span>
            </div>
          </div>
        </div>
