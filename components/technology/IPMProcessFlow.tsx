...
const STATIONS: Station[] = [
  { id:1,  name:'Farmer Registration',    stat:'100+ Farmers',       desc:'Farmers in the programme are given priority guidance and soil preparation. A good rapport is established with all of them before cultivation begins. Each farmer receives a dedicated programme ID and orientation training on IPM norms.' },
  { id:2,  name:'Regular Farm Visits',    stat:'Weekly Inspections', desc:'Our team members visit each farmer\'s individual fields between every visit and supervise farms. They provide inputs on chemicals required, manual weeding, identified problems, and any requirements.' },
  { id:3,  name:'Residue Mapping',        stat:'Zero Tolerance',     desc:'Every land registry of pesticide doctors is checked to ensure none of the farmers on our list have purchased any kind of harmful chemical. A residue map is maintained for every registered farm.' },
  { id:4,  name:'Agronomist Support',     stat:'Expert Guided',      desc:'In case of farm problems not reliably resolved by standard guidance, our expert agronomists step in with precisely calibrated, scientifically proven solutions tailored to each farm\'s specific situation.' },
  { id:5,  name:'Premium Incentive',      stat:'Better Pricing',     desc:'A high premium is paid to farmers, ensuring better economic status and special treatment results. They actively and independently represent our farming community and earn more for following IPM norms.' },
  { id:6,  name:'Compliance Literature',  stat:'Lab Verified',       desc:'Pamphlets and brochures are distributed promptly by the team and sent to laboratories for specific residue-testing. This leaves very little risk of non-compliance at any stage of cultivation.' },
  { id:7,  name:'Contamination Check',    stat:'100% Screened',      desc:'Our sampling quality system is carefully applied at the exact deterrence stage. Any contamination bugs are handled and treated at our processing and cleaning plant before goods proceed.' },
  { id:8,  name:'Direct Container',       stat:'IPM-Only Loading',   desc:'Machines are cleared 100% to avoid contamination from any IPM norms. Only IPM-certified material is dispatched — all other stocks are kept completely separate at every stage.' },
  { id:9,  name:'SGS Pre-Shipment',       stat:'SGS Certified',      desc:'After verifying goods are dispatched to our warehouse, shipment sampling is sent from each market. After laboratory confirms full compliance with MRL standards, only then do we proceed to ship the lot.' },
  { id:10, name:'Farm Traceability',      stat:'100% Traceable',     desc:'Every buyer can be given complete traceability reports to the farm level — giving them 100% confidence in what they receive. Full chain of custody documentation is provided for every consignment.' },
];
