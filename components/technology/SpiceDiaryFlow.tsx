...
const STATIONS: Station[] = [
  { id:1,  name:'Bay Leaves',    stat:'Tejpatta',        image:'/images/spice_farm.png', desc:'Bay leaves have crowned Olympic champions and flavoured ancient feasts for millennia. Our Tejpatta originates from the laurel forests of India, carrying a distinctive cinnamon-clove aroma that\'s prized in slow-cooked curries, biryanis, and rich stocks across the globe.' },
  { id:2,  name:'Black Pepper',  stat:'Kali Mirch',      image:'/images/products/blackkpepper.png', desc:'Once traded as currency in medieval Europe, our Black Pepper is harvested from the lush Malabar coast of Kerala. Rich in piperine, it enhances bioavailability of nutrients and brings sharp, aromatic heat that defines fine cuisines worldwide.' },
  { id:3,  name:'Cardamom',      stat:'Elaichi',         image:'/images/products/spices-hero.png', desc:'Known as the Queen of Spices, our green cardamom is sourced from the misty Western Ghats of Idukki, Kerala. Its complex floral-citrus aroma is indispensable in chai, biryanis, Middle Eastern desserts, and premium spice blends.' },
  { id:4,  name:'Chilli',        stat:'Lal Mirch',       image:'/images/products/chilli-v4.png', desc:'India\'s fiery crown jewel. Our Guntur and Byadgi chillies deliver everything from deep blood-red colour to explosive heat. Rich in Vitamin C and capsaicin, they define heat profiles in cuisines across five continents.' },
  { id:5,  name:'Cinnamon',      stat:'Dalchini',        image:'/images/products/spices-grid.png', desc:'One of the oldest known spices, mentioned in 2700 BC Chinese texts and the Bible. Our Ceylon-type cinnamon brings delicate, sweet warmth to baking, chai, and Ayurvedic formulations — with proven blood-sugar management benefits.' },
  { id:6,  name:'Cloves',        stat:'Laung',           image:'/images/products/masala.png', desc:'Cloves sparked the Age of Exploration — wars were fought for control of their trade routes. Our dried flower buds deliver eugenol-rich intensity for biryanis, garam masala, mulled wine, and dental formulations worldwide.' },
  { id:7,  name:'Coriander',     stat:'Dhania',          image:'/images/products/coriander-v4.png', desc:'Seeds and leaves — two distinct spices from one plant. Our Rajasthan coriander seeds are high in linalool, delivering citrusy warmth ideal for curry powders, sausages, and Middle Eastern spice blends — one of the most consumed herbs globally.' },
  { id:8,  name:'Ginger',        stat:'Adrak',           image:'/images/products/curry-hero.png', desc:'Used for over 5,000 years as food and medicine alike, our ginger rhizomes are harvested at peak gingerol content for maximum anti-inflammatory and anti-nausea potency. A universal staple in Asian cuisine and the global wellness market.' },
  { id:9,  name:'Turmeric',      stat:'Haldi',           image:'/images/products/turmeric-v4.png', desc:'India produces 80% of the world\'s turmeric. Our Erode-sourced Haldi achieves >3.5% curcumin content — significantly above the global average — delivering the iconic golden colour and proven anti-inflammatory power the world demands.' },
  { id:10, name:'Cumin',         stat:'Jeera',           image:'/images/products/cumin-v4.png', desc:'A cornerstone of Indian, Mexican, and North African cooking for 5,000 years. Our drought-resilient Rajasthan jeera is harvested at peak aroma, delivering an earthy, warm depth to spice blends, tempering oils, and street food worldwide.' },
];
