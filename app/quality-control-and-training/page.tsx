    ...
    <main style={{ background: '#000', minHeight: '100vh', color: '#fff' }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <h1 style={{ fontFamily: SERIF, fontSize: 'clamp(32px,6vw,80px)', fontWeight: 700, color: '#fff', lineHeight: 1.0, letterSpacing: '-0.03em', margin: '0 0 20px' }}>
            Quality Control<br />&amp; Training
          </h1>
          <p style={{ fontFamily: SANS, fontSize: 'clamp(14px,1.2vw,16px)', color: 'rgba(255,255,255,0.45)', lineHeight: 1.75, margin: 0 }}>
      ...
      <section id="pesticide-testing" style={{ padding: 'clamp(60px,8vw,100px) clamp(24px,5vw,80px)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontFamily: SERIF, fontSize: 'clamp(28px,4vw,56px)', fontWeight: 700, color: '#fff', letterSpacing: '-0.02em', margin: '0 0 24px' }}>Pesticide Testing</h2>
          ...
          <p style={{ fontFamily: SANS, fontSize: 'clamp(13px,1.1vw,15px)', color: 'rgba(255,255,255,0.45)', lineHeight: 1.85, marginBottom: 40 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 24, flexWrap: 'wrap' }}>
            <div style={{
              ...
              <div style={{ fontFamily: MONO, fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)' }}>Accreditation</div>
              <div style={{ fontFamily: SERIF, fontSize: 'clamp(36px,6vw,80px)', fontWeight: 700, color: '#fff', lineHeight: 1 }}>ISO</div>
              <div style={{ fontFamily: SERIF, fontSize: 'clamp(32px,5vw,64px)', fontWeight: 700, color: CRIMSON, lineHeight: 1 }}>17025</div>
              <div style={{ fontFamily: SANS, fontSize: 12, color: 'rgba(255,255,255,0.35)', marginTop: 4 }}>Certified</div>
            </div>
            <div style={{
              ...
              <div style={{ fontFamily: MONO, fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)' }}>Pesticide Molecules</div>
              <div style={{ fontFamily: SERIF, fontSize: 'clamp(36px,6vw,80px)', fontWeight: 700, color: '#fff', lineHeight: 1 }}>200+</div>
              <div style={{ fontFamily: SANS, fontSize: 12, color: 'rgba(255,255,255,0.35)', marginTop: 4 }}>Pesticides Screened</div>
            </div>
            <div style={{
              background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)',
              borderRadius: 20, padding: '32px 40px',
              ...
              <div style={{ fontFamily: MONO, fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)' }}>Instruments</div>
              <div style={{ fontFamily: SERIF, fontSize: 'clamp(36px,6vw,80px)', fontWeight: 700, color: '#fff', lineHeight: 1 }}>GC-MS</div>
              <div style={{ fontFamily: SANS, fontSize: 12, color: 'rgba(255,255,255,0.35)', marginTop: 4 }}>+ LC-MS/MS</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ══ ALLERGEN CONTROLS ═════════════════════════════════ */}
      <section id="allergen-controls" style={{ padding: 'clamp(60px,8vw,100px) clamp(24px,5vw,80px)', background: 'rgba(255,255,255,0.015)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: 860, margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontFamily: SERIF, fontSize: 'clamp(28px,4vw,56px)', fontWeight: 700, color: '#fff', letterSpacing: '-0.02em', margin: '0 0 16px' }}>Allergen Controls</h2>
          <p style={{ fontFamily: SANS, fontSize: 'clamp(13px,1.1vw,15px)', color: 'rgba(255,255,255,0.45)', lineHeight: 1.75, margin: '0 0 48px', maxWidth: 620, marginLeft: 'auto', marginRight: 'auto' }}>
      ...
      {/* ══ QUALITY CONTROL ════════════════════════════════════ */}
      <section id="quality-control" style={{ padding: 'clamp(60px,8vw,100px) clamp(24px,5vw,80px)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <h2 style={{ fontFamily: SERIF, fontSize: 'clamp(28px,4vw,56px)', fontWeight: 700, color: '#fff', textAlign: 'center', letterSpacing: '-0.02em', margin: '0 0 48px' }}>Quality Control</h2>
          ...
          <div style={{ display: 'flex', gap: 'clamp(32px,5vw,72px)', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1, minWidth: 280 }}>
              ...
              <p style={{ fontFamily: SANS, fontSize: 'clamp(13px,1.1vw,15px)', color: 'rgba(255,255,255,0.45)', lineHeight: 1.85, marginBottom: 32 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                {[
                  ...
                  <div key={item} style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                    ...
                    <span style={{ fontFamily: SANS, fontSize: 13.5, color: 'rgba(255,255,255,0.5)' }} dangerouslySetInnerHTML={{ __html: item }} />
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* ══ TRAINING ══════════════════════════════════════════ */}
      <section id="training" style={{ position: 'relative', overflow: 'hidden', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        {/* Background */}
        ...
        <div style={{ position: 'relative', zIndex: 1, padding: 'clamp(60px,8vw,100px) clamp(24px,5vw,80px)' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 48 }}>
              <h2 style={{ fontFamily: SERIF, fontSize: 'clamp(28px,4vw,56px)', fontWeight: 700, color: '#fff', letterSpacing: '-0.02em', margin: '0 0 20px' }}>Training</h2>
              <p style={{ fontFamily: SANS, fontSize: 'clamp(13px,1.1vw,15px)', color: 'rgba(255,255,255,0.45)', lineHeight: 1.8, maxWidth: 720, margin: '0 auto' }}>
            ...
            <div style={{
              ...
              <div style={{ flex: 1, minWidth: 220 }}>
                ...
                <div style={{ fontFamily: SANS, fontSize: 13, color: 'rgba(255,255,255,0.45)', lineHeight: 1.6 }}>
              ...
              <div style={{ display: 'flex', gap: 20, flexWrap: 'wrap' }}>
                {[{ val: 'Annual', label: 'Training Cycle' }, { val: '100%', label: 'Staff Covered' }].map(s => (
                  <div key={s.label} style={{ textAlign: 'center' }}>
                    ...
                    <div style={{ fontFamily: MONO, fontSize: 9, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.35)', marginTop: 4 }}>{s.label}</div>
                  </div>
                ))}
              </div>
            </div>
